#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# SlientC2 – Çıktılar terminale yazılır, prompt açık kalır (Popen ile)
...
# ========== KOMUT İŞLEYİCİLER (Popen ile, çıktılar terminale) ==========
def run_script(script_name, args):
    ...
    try:
        subprocess.Popen(cmd)  # stdout=None, stderr=None (terminale yazılır)
    except Exception as e:
...
def cmd_help():
    ...
    for line in help_lines:
        print(gradient_text(pad + line))
    print(gradient_text(pad + " " * 4 + "Örnek: L7, Layer7, L4, Layer4, udp, httpflood, cfpro, flood, http-raw, http-socket, http-rand, https-spoof, tls, tls2, tls3, httpflood2, slow, theme, clear, history, stop\n"))
