#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# SlientC2 – Gelişmiş DDoS Aracı + info komutu (tek dosya)
...
def cmd_info(args):
    if len(args) < 1:
        ...
        print("Örnek: info 1.1.1.1")
        print("       info https://hedef.com")
        return
...
def cmd_help():
    ...
    help_lines = [
        ...
        "║  info       - Hedef hakkında bilgi topla (IP, WHOIS, Cloudflare, port tarama)",
    ...
    for line in help_lines:
        print(gradient_text(pad + line))
    print(gradient_text(pad + " " * 4 + "Örnek: info 1.1.1.1, theme 8, promptcolor red white blue\n"))
