...
# ========== 8 RENK TEMASI (Başlangıç renkleri koyu, beyaz sona) ==========
TEMA_VARSAYILAN = 1
TEMALAR = {
    1: {"isim": "Varsayılan (Mavi-Mor)", "palet": [117, 81, 45, 39, 45, 81, 117, 153, 189, 255, 254, 253, 255]},
...
def history_listele():
    ...
    for i, entry in enumerate(history[-20:], 1):
        ...
        print(f"{b}║ {line.ljust(68)[:68]} ║{r}")
    print(f"{b}╚══════════════════════════════════════════════════════════════════════╝{r}\n")

# ========== GRADIENT TEXT (Tek renk - kutular bozulmasın) ==========
