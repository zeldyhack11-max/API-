...
def center_text(text, width=72):
    """Metni verilen genişlikte ortalar"""
    return text.center(width)

def show_logo_and_boxes():
    os.system('clear')
    for line in ascii_art:
        print(gradient_text(center_text(line)))
    print()
    # Büyük kutu (ortalanmış)
    print(gradient_text("╔══════════════════════════════════════════════════════════════════╗".center(72)))
    print(gradient_text("║                                                                  ║".center(72)))
    print(gradient_text("║                    DdoS ATTACK TOOL                              ║".center(72)))
    print(gradient_text("║                  Telegram: @SlientBotnet                         ║".center(72)))
    print(gradient_text("║                                                                  ║".center(72)))
    print(gradient_text("╚══════════════════════════════════════════════════════════════════╝".center(72)))
    print()
    # Küçük kutu (ortalanmış)
    print(gradient_text("╔══════════════════════════════════════════════════════════════════╗".center(72)))
    print(gradient_text("║                    write 'help' for usage                        ║".center(72)))
    print(gradient_text("╚══════════════════════════════════════════════════════════════════╝".center(72)))
    print()
...
def prompt():
    ...
    if PROMPT_STYLE == 1:
        ...
        if PROMPT_GRADIENT:
            ...
            # Manuel segment renkleri de smooth gradient olsun
...
def cmd_promptcolor(args):
    ...
    if len(args) == 0:
        ...
        print(gradient_text("  promptcolor 2 <bg1> <bg2> <fg1> <fg2>  → Stil 2 gradient (2 renk)"))
    ...
    if args[0] == "2":
        ...
        PROMPT_STYLE = 2
        PROMPT_GRADIENT = True
        PROMPT_GRADIENT_TYPE = [PROMPT_COLOR_2, PROMPT_COLOR_3]
        print(gradient_text(f"[+] Stil 2 gradient: {PROMPT_COLOR_2} -> {PROMPT_COLOR_3}"))
        return
    if args[0] == "3":
        if len(args) < 2:
