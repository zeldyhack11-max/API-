#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# SlientC2 – Gelişmiş DDoS Aracı (Düz Kutu Çizgileri + Gradient)
...
# ========== GRADIENT TEXT (Kutu çizgilerini atlar) ==========
def gradient_text(text):
    """Kutu çizgilerini atlayarak gradient uygular"""
...
def cmd_help():
    ...
    for line in help_lines:
        print(gradient_text(pad + line))
    print(gradient_text(pad + " " * 4 + "Örnek: theme 8, promptcolor red white blue\n"))
