...
# Yeni stil için segmentler ve renkler
...
# Renk haritası (isim -> Colorama nesnesi)
COLOR_MAP = {
...
def prompt():
    ...
    if PROMPT_STYLE == 1:
        ...
        # Yeni stil (tek satır, iki segment)
        custom_prompt = (
...
def cmd_help():
    ...
    for line in help_lines:
        print(gradient_text(pad + line))
    print(gradient_text(pad + " " * 4 + "Örnek: promptstyle 2, setprompt mybot, promptcolor cyan black magenta white\n"))
