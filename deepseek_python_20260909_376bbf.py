#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# SlientC2 – Gelişmiş DDoS Aracı (8 Tema + Ultra Yumuşak Gradient Prompt + Tüm Metodlar)
...
TEMALAR = {
    ...
    8: {"isim": "Kırmızı-Beyaz", "palet": [196, 197, 198, 199, 200, 201, 231, 231, 231, 231, 231, 231, 231, 231]}
}
...
def build_gradient_palette(colors, length):
    """Ultra yumuşak geçişli gradient palette oluşturur."""
    if len(colors) < 2:
...
# ========== PROMPT ÖZELLEŞTİRME (ULTRA YUMUŞAK GRADIENT) ==========
...
def prompt():
    ...
    if PROMPT_STYLE == 1:
        ...
        if PROMPT_GRADIENT:
            ...
            result = gradient_bg_text(full_text, palette) + Fore.BLACK + Style.BRIGHT
            print(result, end="")
            sys.stdout.write("\033[0m ")
            sys.stdout.flush()
            return input()
