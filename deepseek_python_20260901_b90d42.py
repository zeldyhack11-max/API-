#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# SlientC2 – Gelişmiş DDoS Aracı (Tüm hatalar düzeltildi + FIVEM eklendi)
...
def cmd_game():
    ...
    for line in game_lines:
        print(gradient_text(pad + line))
    print(gradient_text(pad + " " * 4 + "Not: fortnite ve fivem saldırıları UDP tabanlıdır.\n"))
...
def cmd_help():
    ...
    for line in help_lines:
        print(gradient_text(pad + line))
    print(gradient_text(pad + " " * 4 + "Örnek: L7, Layer7, L4, Layer4, GAME, udp, httpflood, cfpro, flood, http-raw, http-socket, http-rand, https-spoof, tls, tls2, tls3, httpflood2, slow, tcpflood, fortnite, fivem, saldırı_goster, saldırı_kapan, theme, clear, history, stop\n"))
