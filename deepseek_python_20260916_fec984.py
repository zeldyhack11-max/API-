...
def login():
    ...
    if username == ADMIN_USER and password == ADMIN_PASS:
        ...
        IS_VIP = True
        os.system('clear')
        print('\033[38;2;255;50;50m[ ADMIN ]\033[0m | \033[38;2;0;255;255mWelcome ' + username + ' !\033[0m | \033[38;2;233;233;233mOwner: Zeldy\033[0m')
        time.sleep(0.5)
        return True
    ...
    for user in vip_list:
        if user.get("username") == username and user.get("password") == password:
            ...
            IS_VIP = True
            os.system('clear')
            print('\033[38;2;255;215;0m[ VIP ]\033[0m | \033[38;2;0;255;255mWelcome ' + username + ' !\033[0m | \033[38;2;233;233;233mSlientC2\033[0m')
            time.sleep(0.5)
            return True
    ...
    if username and password:
        ...
        IS_VIP = False
        os.system('clear')
        print('\033[38;2;200;200;200m[ GUEST ]\033[0m | \033[38;2;0;255;255mWelcome ' + username + ' !\033[0m | \033[38;2;233;233;233mSadece DEFL methodlar\033[0m')
        time.sleep(0.5)
        return True
...
def cmd_menu():
    ...
    r = "\033[0m"
    vip_color = f"\033[38;5;{c}m"
    defl_color = f"\033[38;5;{c}m"
    title_color = f"\033[38;5;{c}m"
